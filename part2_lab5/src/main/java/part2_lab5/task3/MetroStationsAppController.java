...
import part2_lab5.task1.HourForDB;
import part2_lab5.task1.MetroStationForDB;
import part2_lab5.task1.MetroStations;
...
import static part2_lab5.task1.DBUtils.*;


/**
 * Controller class for managing the Metro Stations application.
...
public class MetroStationsAppController implements Initializable {
    ...
    /**
     * Creates a new file and resets the application state.
    ...
    private void fileNew(ActionEvent event) {
        ...
        logger.info("New file created in application");
    }

    /**
     * Opens an existing JSON file and loads its data into the application.
     * @param event The action event triggered by the user.
     */
    @FXML
    ...
    /**
     * Exits the application. Closes any open connections and logs the application close event.
    ...
    /**
     * Displays an informational alert about the application.
