...
/** The {@code DivisorSearcherTest} class provides unit tests for the {@link DivisorFinder} class. */
class DivisorSearcherTest {
    /**
     * Tests the {@link DivisorFinder#findAllPositiveNumberDivisors(int)} method with positive numbers.
     * <p> It uses a {@link CsvSource} to provide a set of numbers and their expected divisors.
     ...
     * <p> This test checks if the method correctly throws an {@link IllegalArgumentException}
     * when the input number is not positive. It uses a {@link ValueSource} to provide a set of non-positive numbers.
