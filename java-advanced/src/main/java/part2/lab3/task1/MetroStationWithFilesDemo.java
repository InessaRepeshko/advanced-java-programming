...
public class MetroStationWithFilesDemo {
    private static final String TXT_FILE_PATH = "src/main/resources/part2/lab3/task1/MetroStation.txt";
    private static final String XML_FILE_PATH = "src/main/resources/part2/lab3/task1/MetroStation.xml";
    private static final String JSON_FILE_PATH = "src/main/resources/part2/lab3/task1/MetroStation.json";
