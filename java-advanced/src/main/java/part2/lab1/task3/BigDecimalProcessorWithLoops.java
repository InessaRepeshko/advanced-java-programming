...
public class BigDecimalProcessorWithLoops implements BigDecimalProcessor {
    ...
    /**
     * Constructs a new BigDecimalHandlerByLoops with the specified bound for random values.
    ...
    /**
     * Sorts the given list in descending order by absolute value using a bubble sort algorithm.
